...
<div class="box-positon">
    ...
    <form class="ropt">
        <input type="submit" onclick="this.form.action='/control/brand/list.html';" value="返回列表" class="return-button"/>
    </form>
    <div class="clear"></div>
</div>
<div class="body-box" style="float:right">
    <form id="jvForm" action="/control/brand/edit.html" method="post">
