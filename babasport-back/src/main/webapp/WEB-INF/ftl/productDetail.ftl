...
<script type="text/javascript">
    ...
    function colorToRed(target, colorId) {
        $(target).siblings().attr('class', 'changToWhite');
    ...
    function sizeToRed(target, size) {
        if ('not-allow' == $(target).attr('class')) {
            return;
        }
...
<div class="w ofc mt">
    ...
    <div class="r" style="width: 640px">
        <ul class="uls form">
            ...
            <li><label>巴 巴 价：</label><span class="word"><b class="f14 red mr" id="bPrice">￥128.00</b>(市场价:<del>￥150.00</del>)</span>
            </li>
