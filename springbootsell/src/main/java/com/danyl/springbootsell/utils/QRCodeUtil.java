...
public class QRCodeUtil {
    ...
    // 二维码图片格式
    private static final List<String> IMAGE_TYPE = Arrays.asList("jpg", "png");
     ...
     * @param targetPath 生成二维码图片目录
     * @param size       二维码图片尺寸 null or your size
     * @param logoPath   插入图片目录
     */
    public static boolean zxingCodeCreate(String content, String targetPath, Integer size, String logoPath) {
        try {
            String imageType = targetPath.substring(targetPath.lastIndexOf(".") + 1).toLowerCase();
