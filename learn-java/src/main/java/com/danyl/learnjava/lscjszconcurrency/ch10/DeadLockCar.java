    ...
    public void run() {
        if (myDirect == south) {
            try {
                ...
                System.out.println("cart to south is killed");
            } finally {
        ...
        if (myDirect == north) {
            try {
                ...
                System.out.println("cart to north is killed");
            } finally {
        ...
        if (myDirect == west) {
            try {
                ...
                System.out.println("cart to west is killed");
            } finally {
                if (north.isHeldByCurrentThread()) {
                    north.unlock();
                }
        ...
        if (myDirect == east) {
            try {
                ...
                System.out.println("cart to east is killed");
            } finally {
                if (south.isHeldByCurrentThread()) {
                    south.unlock();
                }
