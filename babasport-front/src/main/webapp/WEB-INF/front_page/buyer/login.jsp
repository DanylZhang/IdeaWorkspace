...
<div class="sign">
    ...
    <div class="r">
        ...
        <form id="jvForm" action="/shopping/login.html" method="post">
            ...
            <ul class="uls form">
                ...
                <li><label for="captcha">验证码：</label>
                    ...
                    <img src="/shopping/captcha.html" onclick="this.src='/shopping/captcha.html?d='+new Date()"
                         class="code" alt="换一张"/><a href="javascript:void(0);"
                                                    onclick="$('.code').attr('src','/shopping/captcha.html?d='+new Date())"
                                                    title="换一张">换一张</a></li>
