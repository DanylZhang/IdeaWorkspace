...
<head>
    ...
    <script type="text/javascript">
        ...
        function fqBrand(brandId) {
            window.location.href = '/product/list.html?keyword=' + keyword + '&brandId=' + brandId + '&price=' + price;
        }
        ...
        function cleanFq(key) {
            if (key == '品牌') {
                window.location.href = '/product/list.html?keyword=' + keyword + '&brandId=' + '&price=' + price;
            } else if (key == '价格') {
                window.location.href = '/product/list.html?keyword=' + keyword + '&brandId=' + brandId + '&price=';
            }
        }
    </script>
</head>
...
<div class="w ofc">
    ...
    <div class="r wr">
        ...
        <ul class="uls filter">
            <c:if test="${not empty param.brandId or not empty param.price}">
                <li><label>已选条件：</label>
                    <p class="sel">
                        <c:forEach items="${fq}" var="f">
                            <a href="javascript:void(0);" onclick="cleanFq('${f.key}')">
                                <em>${f.key}：</em>${f.value}
                ...
                <li><b>品牌：</b>
                    <p>
                        <c:forEach items="${brands}" var="brand">
                            <a href="javascript:void(0);" onclick="fqBrand(${brand.id})"
            ...
            <c:if test="${empty param.price}">
                <li><b>价格：</b>
                    <p>
                        ...
                        <a href="javascript:void(0);" title="0-79" onclick="fqPrice('0-79')">0-79</a>
                        <a href="javascript:void(0);" title="80-199" onclick="fqPrice('80-199')">80-199</a>
                        <a href="javascript:void(0);" title="200-299" onclick="fqPrice('200-299')">200-299</a>
                        <a href="javascript:void(0);" title="300-499" onclick="fqPrice('300-499')">300-499</a>
                        <a href="javascript:void(0);" title="500-599" onclick="fqPrice('500-599')">500-599</a>
                        <a href="javascript:void(0);" title="600以上" onclick="fqPrice('600')">600以上</a>
                    </p></li>
            </c:if>
